...
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Galleta Nick', 3.00, 50, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Cerveza Pilsen', 20, 200, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Cerveza Cuzqueña', 35, 300, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Cerveza Pilsen', 10, 200, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Dulce Halls negro', 1, 100, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Preservativo Durex', 15, 500, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Preservativo Piel', 10, 500, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Preservativo Gents', 12, 500, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Gaseosa Inka Cola', 5, 100, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Gaseosa Coca Cola', 5, 100, GETDATE())
insert into Producto (Descripcion, Precio, CantidadStock, FechaCreado) values ('Energizante Moster', 15, 100, GETDATE())
-- Reserva Consumo
-- Comprobante Pago
