...
(1,'Laptop Core i5 8GB RAM',NULL,NULL,2500.00,10,'Tecnología'),

(2,'Mouse óptico 1600 DPI',NULL,NULL,45.00,50,'Accesorios'),

(3,'Teclado RGB switches blue',NULL,NULL,150.00,20,'Accesorios'),

(4,'Monitor LED Full HD',NULL,NULL,650.00,15,'Tecnología'),

(5,'Silla ergonómica reclinable',NULL,NULL,780.00,8,'Muebles'),

(6,'Prueba',NULL,NULL,100.00,1000,'Cosa'),

(7,'ttt Silla ergonómica reclinable',NULL,NULL,780.00,8,'Muebles');
